...
int parse_multiple_rows() {
    Cellulose client = fromCSV("tests/csvs/multiple_lines.csv");
...
int parse_large_cells() {
    Cellulose client = fromCSV("tests/csvs/long_cells.csv");
...
int many_rows_test() {
    Cellulose client = fromCSV("tests/csvs/lots_of_lines.csv");
...
int csvTypeTest() {
    Cellulose client = fromCSV("tests/csvs/int_and_str.csv");
